...
if __name__ == "__main__":
    ...
    plt.figure(figsize=(12.0 / 2.54, 15.0 / 2.54))
    ...
    for i, df in enumerate([crta_sns, crta_snse]):
        ...
        for axes, k in zip(subplot_axes[i::2], ["kappa", "kappa_tau_crta", "tau_crta"]):
    ...
    for i, y_max in enumerate([10.0, 1.0, 25.0]):
    ...
    for i, (axes, loc) in enumerate(zip(subplot_axes, subplot_label_locs)):
        axes.add_artist(AnchoredText(r"({0})".format(chr(97 + i)), loc=loc))
